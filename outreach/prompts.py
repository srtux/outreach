...
1. Use the `google_search` tool to find up to {target} elementary and middle schools in that area. Focus on finding NEW schools that have not already been thoroughly researched.
...
Given a city and state (and optionally a list of already researched schools):
1. Use the `google_search` tool to find up to {target} high schools in that area. Focus on finding NEW schools that have not already been thoroughly researched.
